...
public class Geometria {
	public static void main(String[] args) {
		...
		//Entrade de dados 
		System.out.print("Digite a quantidae de lados:");
		...
		switch (quantidadeLados) {
			...
			case 4:
				...
				break; 
			case 5:
				area = ((5 * Math.pow(tamanhoAresta, 2)) /
						(4 * Math.tan(36)));
				break;
			case 6: 
				area = ((3 *Math.pow(tamanhoAresta, 2) *
						Math.sqrt(3)) / 2);
				break;
			case 7:
				area = ((7 / 4) * Math.pow(tamanhoAresta, 2) *
						(1 / Math.tan(51.4285714)));
				break;
		}
